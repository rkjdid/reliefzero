...
class Page (models.Model):
  ...
  page_title = models.CharField(
    ...
    max_length=300, null=True, blank=True, default=settings.PAGE_TITLE)
  ...
  def setMeta(self):
    ...
    post_save.disconnect(setMeta, sender=Page)
    self.save()
    post_save.connect(setMeta, sender=Page)
...
# post/pre_save shit
def setMeta(sender, instance, **kwargs):
  instance.setMeta()
